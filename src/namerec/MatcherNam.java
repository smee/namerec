...
public class MatcherNam {
    ...
    private static int goalClassSum=928;  // Sollte berechnet werden: summe der Zielklassen	
	...
	//System.out.println("MatcherGCO incoming:"+item+" "+wordVec.toString()+classVec.toString()+" "+klassKeys.toString()+" "+patterns.toString());
