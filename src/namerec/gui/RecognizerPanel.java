 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class RecognizerPanel extends JPanel {
...
/**
		...
		if (calcButton == null) {
			...
			calcButton.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {    
				    final JDialog dialog = new JDialog((JFrame)null,"Running...",true);
                    ...
                    SwingWorker sw = new SwingWorker() {
                        public Object construct() {
                            try {
                                ...
                                JOptionPane.showMessageDialog(RecognizerPanel.this,bos.toString(),"Error on running",JOptionPane.ERROR_MESSAGE);
                            }
                            return null;
                        }
	...
	private JButton getLoadButton() {
		if (loadButton == null) {
			...
			loadButton.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {    
				    File f=FileSelector.getUserSelectedFile(RecognizerPanel.this,"Load configuration", getConfigFileFilter(),FileSelector.OPEN_DIALOG);
				    if(f != null) {
				        Config cfg;
                        try {
                            cfg = new Config(f);
                            ...
                            JOptionPane.showMessageDialog(RecognizerPanel.this, "Error: "+e1.getMessage(),"Error on loading configfile",JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
			});
    ...
    private FileFilter getConfigFileFilter() {
        return new FileFilter() {
            ...
            public boolean accept(File f) {
                return f.isDirectory() || (f.isFile() && f.getName().toLowerCase().endsWith(".cfg"));
            }
		...
		if (saveButton == null) {
			...
			saveButton.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {    
                    ...
                    File f=FileSelector.getUserSelectedFile(RecognizerPanel.this,"Save configuration", getConfigFileFilter(),FileSelector.SAVE_DIALOG);
                    if(f != null) {
                        try {
                            Config cfg = getConfig();
                            cfg.saveToFile(f);
                        } catch (Exception e1) {
                            JOptionPane.showMessageDialog(RecognizerPanel.this, "Error: "+e1.getMessage(),"Error on saving configfile",JOptionPane.ERROR_MESSAGE);
                        }
                    }
	 ...
	 * This method initializes jPanel3	
			dbConfig.add(getDBConfigPanel1(), null);
	 * 	
	 * @return javax.swing.JPanel	
	 */    
