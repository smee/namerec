 ...
 */
public class RecognizerPanelOld extends WortschatzModul {
     ...
     */
    public RecognizerPanelOld(WortschatzTool wTool) {
        super(wTool);
        initialize();
    }
    ...
    private JTabbedPane getJTabbedPane() {
        if (jTabbedPane == null) {
            ...
            jTabbedPane.setMaximumSize(new java.awt.Dimension(800,500));
    ...
    private ConfigPanel getConfigPanel() {
        if (configPanel == null) {
            ...
            configPanel.setPreferredSize(new java.awt.Dimension(800,500));
            configPanel.setMaximumSize(new java.awt.Dimension(800,500));
        }
        return configPanel;
    }
    ...
    private FileConfigPanel getFileConfigPanel() {
        if (fileConfigPanel == null) {
            ...
            fileConfigPanel.setMaximumSize(new java.awt.Dimension(800,500));
        }
                        ...
                        public Object construct() {
                            try {
                                ...
                                JOptionPane.showMessageDialog(
                                        RecognizerPanelOld.this, bos.toString(),
                                        "Error on running",
            ...
            loadButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    File f = FileSelector.getUserSelectedFile(
                            RecognizerPanelOld.this, "Load configuration",
                    ...
                    if (f != null) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(RecognizerPanelOld.this,
                                    "Error: " + e1.getMessage(),
        ...
        if (saveButton == null) {
            ...
            saveButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    File f = FileSelector.getUserSelectedFile(
                            RecognizerPanelOld.this, "Save configuration",
    ...
    private JPanel getDbConfig() {
        if (dbConfig == null) {
            ...
            dbConfig.setMaximumSize(new java.awt.Dimension(800,500));
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new RecognizerPanelOld(null));
        frame.pack();
    ...
    public void setSize(int width, int height) {
        super.setSize(Math.min(width,800), Math.min(height,530));
    }
}
