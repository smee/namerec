 ...
 * @version 1.0
 */
public class KollokSimShortAxis extends ValueAxis
{
  public KollokSimShortAxis(DBUtilUncached dbUtil)
  {
    super(dbUtil);
  }
  ...
  public List getValues(Integer wordNr, List numbers)
  {
    ...
    Vector collocations = this.dbUtil.getCollocationSims(wordNr);
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      ValueAxis yAxis = new KollokSimShortAxis(util);
