...
public class SpellCheckerConsole extends Thread
{
   ...
   */
  private SpreadingActivation spreading = null;

  /**
   * Constructs an instance of the console if the connection was valid.
   * @param connection
   */
  public SpellCheckerConsole(DBConnection connection)
  {
    this.connection = connection;
    this.spreading = new SpreadingActivation(this.connection);
    this.start();
  }
  ...
  public static void main(String[] args)
  {
    ...
    SpellCheckerConsole console = new SpellCheckerConsole(connection);
  }
}