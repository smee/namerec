...
public class CountFileTrianglesWorkingBytes
{
  ...
  public CountFileTrianglesWorkingBytes(String fileName)
  {
    if ( fileName != null )
    {
  ...
  {
    this.stringList = new HashSet(3000000);
    try
    {
      ...
      while ( input.ready() )
      {
        ...
        this.stringList.add(new Pair(s[0],s[1]));
        if (i % 20000 == 0)
        {
  ...
  protected void countTriangles()
  {
    ...
    while ( true )
    {
      ...
      while ( set.size() > 0 )
      {
        ...
        set.remove(curPair);
        this.stringList.remove(curPair);
  ...
  private int searchTriangles(Integer x, Integer y, Set potentialZSet)
  {
    ...
    for ( Iterator it = potentialZSet.iterator() ; it.hasNext() ; )
    {
      ...
      else if ( this.stringList.contains(new Pair(curPair.getY(), y)) )
      {
//        System.out.println("Triangle: ("+x.intValue()+","+curPair.myPair[1].intValue()+","+y.intValue()+")");
  ...
  public static void main(String[] args)
  {
    if ( args.length >= 1 )
    {
      CountFileTrianglesWorkingBytes t = new CountFileTrianglesWorkingBytes(args[0]);
    }
    else if ( args.length < 1 )
    {
      CountFileTrianglesWorkingBytes t = new CountFileTrianglesWorkingBytes(
          "C:\\develop\\WortschatzTool\\data\\triangles\\kollok1_1000.txt");
      t = null;
      CountFileTrianglesWorkingBytes t2 = new CountFileTrianglesWorkingBytes(
          "C:\\develop\\WortschatzTool\\data\\triangles\\kollok2_1000.txt");
      t2 = null;
      CountFileTrianglesWorkingBytes t3 = new CountFileTrianglesWorkingBytes(
          "C:\\develop\\WortschatzTool\\data\\triangles\\kollok3_1000.txt");
      t3 = null;
      CountFileTrianglesWorkingBytes t4 = new CountFileTrianglesWorkingBytes(
