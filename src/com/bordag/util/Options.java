...
/*-------ParaSyntagma--------*/
  ...
  {
    return getAssured(this.INI_PARASYNTAGMA, this.INI_PARASYNTAGMA_MINSECONDARYSIGNIFIKANZ, this.INI_PARASYNTAGMA_MINSECONDARYSIGNIFIKANZ_DEFAULT);
  }
  public void setParaMinSecondarySignifikanz(String newOption)
  {
    setOptionValue(this.INI_PARASYNTAGMA, this.INI_PARASYNTAGMA_MINSECONDARYSIGNIFIKANZ, newOption);
  }
