...
public class TextProcessor {
  ...
  public Vector tokenize(String input) {
    ...
    public void getNEsOfText(String text, NameTable regexp, NameTable classif,NameTable klassKeys, RulesNE rules) throws gnu.regexp.REException, SQLException, IOException, FileNotFoundException { // verbindung
	...
	for (Enumeration en=input.elements();en.hasMoreElements();) { // fuer alle woerter
	    ...
	    } catch (IOException e) {System.out.println("Something wrong in Entity search!"+e.getMessage());}
	    retvec.insert(newCands);

	} // rof Enumeration e
	if (d) System.out.println("Im Satz:"+retvec.toString());
